...
<body class="container-content">
    ...
    <div class="body__rooms rooms">
    	...
    	%>
    	<form class="dp-n form-container" method="get" action="<%= url.urlServer + "rooms" %>">
                ...
                <div class="container_item">
                    ...
                    <p class="infor__cost__maxPeople">
                        <button class="infor__cost">
                            Price: <%= listTypeRoom.get(i).getPrice() %>$
                        </button>

                        <button class="infor__maxPeople">
                            Max Adult: <%= listTypeRoom.get(i).getMaxAdult() %>
                        </button>
                        <button class="infor__maxPeople">
                            Max Child: <%= listTypeRoom.get(i).getMaxChild() %>
                        </button>
                    </p>
                </div>
...
<input type="hidden" id="timePicker__start" name="timePicker__start" value="">
<input type="hidden" id="timePicker__end" name="timePicker__end" value="">
